...
parser.add_argument('-b', '--batch-size', default=77, type=int,
...
def main():
    ...
    # model = md.mobilenet_v2(pretrained=True
    model = MyMobilenetV1(pretrained=True, latent_layer_num=25)
    ...
    # PATH = '/home/lravaglia/work/training-mixed-precision-quantized-networks-master/mobilenet_init_BN1.pth'
    # model = torch.load(PATH)
    # replace_bn_with_brn(
    #     0, model, momentum=0.01, r_d_max_inc_step=4.1e-05,
    #     max_r_max=1.25, max_d_max=0.5
    # )
    ...
    # if 0:
        ...
        # if 0:
        #     # evaluate deployme<nt model on validation set
        ...
        # print("ACC 1: ", val_prec1, "ACC 5: ", val_prec5, "\n")
    ...
    for epoch in range(150): #args.start_epoch, args.epochs):
        ...
        #evaluate on validation set
        val_loss, val_prec1, val_prec5 = validate(
            val_loader, model, criterion, epoch, optimizer)
        ...
        # file = open("mobilenet-relu6.txt","w")
        # file.write('\n Epoch: {0}\t'
    ...
    torch.save(model, 'mobilenet_relu6.pth')


def forward(data_loader, model, criterion, epoch=0, training=False, optimizer=None ):
...
def validate(data_loader, model, criterion, epoch, optimizer ):
