...
_IMAGENET_MAIN_PATH = '/home/lravaglia/work/datasets/imagenet/'
_DATASETS_MAIN_PATH = '/scratch/datasets/imagenet'
#_IMAGENET_MAIN_PATH = os.path.expanduser(_IMAGENET_MAIN_PATH)
...
def get_dataset(name, split='train', transform=None,
    ...
    #train = (split == 'train')
    #root = '/scratch/datasets/imagenet'
